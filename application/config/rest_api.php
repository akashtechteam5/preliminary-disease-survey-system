...
$config['auth_override_class_method']['auth']['user_access'] = 'none';
$config['auth_override_class_method']['auth']['main_access'] = 'none';
$config['auth_override_class_method']['register']['register'] = 'none';
$config['auth_override_class_method']['register']['districts'] = 'none';
$config['auth_override_class_method']['register']['panchayaths'] = 'none';
$config['auth_override_class_method']['register']['chcs'] = 'none';
$config['auth_override_class_method']['register']['states'] = 'none';
$config['auth_override_class_method']['register']['vulnerabilities'] = 'none';
